...
def add_pct_row(row, fileHeader):
	if (getTractPop(row,fileHeader) != 0 and getTract25(row,fileHeader) != 0):
		newList = []
...
for filename in os.listdir(directory):
	...
	outfile_print = []
	perc_header = ["popdense", "percmin", "perclths"]
	outfile_header = ["FIPS", "popdense", "pctpopdense", "percmin", "pctmin", "perclths", "pctlths"]
	...
	# outFileName = "CalEnviroScreen_tract_FeaturePercentiles_" + curr_state + ".csv"
	...
	nopeStr =  "The following Census Tracts either had 0 population or 0 people over 25 years old: "
